...
@Component({
  selector: 'app-desagregado',
  standalone: true,
  imports: [MatCardModule, DecimalPipe],
  templateUrl: './desagregado.component.html',
  styleUrl: './desagregado.component.scss'
})
export class DesagregadoComponent {
  ...
  ngOnInit(): void {
    ...
    this.dataTotalesMacro = this.getDataTotalesMacro(this.dataGeneral)
    console.log(this.dataTotalesMacro );
    //this.dataTotal = this.getDataTotal(this.dataTotalesMacro)
    // setTimeout(() => {
    //   this.Grafico1()
    // }, 1000)
  }
  ...
  getDataTotalesMacro(dataOrigen: any) {
